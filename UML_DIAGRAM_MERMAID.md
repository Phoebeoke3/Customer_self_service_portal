# SwissAxa Customer Self-Service Portal - Architecture Diagrams (Mermaid)

This document contains simplified architecture diagrams using Mermaid syntax, which can be viewed directly in GitHub, VS Code, and many markdown viewers.
...
### Online
- Copy any diagram code block to [Mermaid Live Editor](https://mermaid.live/)

### Other Tools
- Many markdown viewers support Mermaid natively
- Can be exported to PNG/SVG using Mermaid CLI

## Notes

- These diagrams represent the "To Be" architecture
- Current implementation may differ slightly
